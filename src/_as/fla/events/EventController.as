 ...
 *  <li> remove all events of a cluster of objects with one simple line of code </li></p>
    **/
	public class EventController{
         ...
         * @param clusterID - a uniqe id for a cluster of events to be be used to removed items as a group when using EC.remove
         ...
         *  <p>EC.remove(obj,type,listener,false);</p>
         *
         ...
         *  <p>EC.remove(obj,type,listener);</p>
         *
         ...
         *  EC.remove(/project_/); /done eveything will be deleted.<br/><br/>
         *
		...
		/**
         * Removes object events.this is not part of the public EC methods as it is encapsulated in the EC.remove.
		...
		/**
         * Removes cluster events.this is not part of the public EC methods as it is encapsulated in the EC.remove.
