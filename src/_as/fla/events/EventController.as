...
package _as.fla.events{
	...
	/**
 *     EventController is the heart of EC.  offering exactly the same functionality plus useful
 ...
 *  <li> remove all events of a cluster of objects with one simple line of code </li></p>
    **/
	public class EventController{
         ...
         *
         *  please reffer to the information on addEventListerner at Adobes documentation for full information on Events. working with the event controller
         ...
         * 
         *  <p>EC.add(obj,type,listener,flase,0,false,"myCluster");</p>
         *
         ...
         *
         *  the method reruns a Boolean value. true if th event has been added to the Que of events and false if the event is
