...
package _as.fla.events.log{
	...
	/**
		...
		* all log events will go through Arthropod. The implementation was tested on  Carl Calderon's <a href="http://arthropod.stopp.se/index2.php/?page_id=3">Arthropod Debugger v1.0</a>.
		* <br/> <br/><pre name="code" class="js">
		* import _as.fla.events.LEC;
		* import _as.fla.events.log.ArthropodLog;
		*
		* LEC.plug(ArthropodLog); </pre><br/>
	**/
