...
package _as.fla.events.log{
	...
	* all log events will go through Alcon.  The implementation was tested on <a href="http://blog.hexagonstar.com/downloads/alcon/">Alcon Debugger v3.1.3</a>.
	* <br/> <br/>
	* <p> import _as.fla.events.LEC;<br/>
	* import _as.fla.events.log.AlconLog<br/><br/>
	* LEC.plug(AlconLog); <br/><br/>
	**/
