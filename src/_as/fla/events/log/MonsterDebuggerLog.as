...
package _as.fla.events.log{
	...
	/**
		...
		* all log events will go through Monster.  The implementation was tested on <a href="http://demonsterdebugger.com/">De Monster Debugger v2.5.1</a>.
		* <br/> <br/>
		* <p> import _as.fla.events.LEC;<br/>
		* import _as.fla.events.log.MonsterDebuggerLog<br/><br/>
		* LEC.plug(MonsterDebuggerLog); <br/><br/>
	**/
